...
<?php
    ...
    <div class="actorsList">
        ...
        <button class="BTNacotor"><a href="index.php?action=deleteActor&id=<?=$actor["id_actor"] ?>">Supprimer l'acteur</a></button> 
        <button class="BTNacotor"><a href="index.php?action=deletePerson&id=<?=$actor["id_actor"] ?>">Supprimer la personne</a></button>               
    </div>    
<?php 
} 
?> 
